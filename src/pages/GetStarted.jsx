      ...
      <div className='mx-3 md:mx-[7%]'>
         <div className='flex flex-row justify-between md:space-x-20'>
            ...
            <div className=' w-full md:w-[30%] '>
               <p className='text-right mb-24'> Already have an account? <Link to='/' className='text-blue-800 font-semibold'>Sign in </Link> </p> 
               <h2 className='mt-10 text-3xl font-semibold'>Join Us!</h2>
               <p className='mb-10 md:mb-28'>To begin this journey, tell us what type of account you'd be opening.</p>
               <div className=' flex flex-col justify-end items-center space-y-2 '>
                  <Link to='/signup' className='flex flex-row space-x-3 justify-center items-center border transition-[border] hover:border-2 hover:border-blue-400 p-5 rounded-md'>
