    ...
    <>  
      <nav className="bg-white border-gray-200 dark:bg-gray-900">
        ...
        <div className="flex md:order-2 space-x-3 space- md:space-x-3 rtl:space-x-reverse">
            <Link to='/getstarted' className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-sm text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Get started</Link>
            <DarkMode/>
